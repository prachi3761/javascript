...
button.addEventListener('click',()=>{
  ...
  const result= number1+number2;
   ...
   /// making multiple circles in background 
document .body.addEventListener("click", (event)=>  {
   ...
   const color = ["red","blue", "orange", "green", "purple", "white"];
   ...
   circle.style.backgroundColor = color[Math.floor(Math.random()*color.length)];
    ...
    //button ka backgorund color change kar sakte agar botton par click kiya same color of button  h ussi ka same background ka ho jayega 
